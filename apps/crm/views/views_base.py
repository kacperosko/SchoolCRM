...
from apps.crm.models import Student, Lesson, LessonAdjustment, Person, StudentPerson, Note, Notification, WatchRecord, Location, \
    Statutes, Group, GroupStudent, AttendanceList, AttendanceListStudent, Invoice, InvoiceItem
from apps.service_helper import get_model_object_by_prefix, get_model_by_prefix, check_is_admin, check_permission, custom_404, custom_500
